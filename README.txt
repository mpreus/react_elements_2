Project made with react lists data accordingly to the button you select. You may see a list of all users, women only or men only. 
There is react and 'switch' method in use.
